...
import com.hallett.bujoass.presentation.ui.dashboard.DashboardFragmentViewModel
...
val viewModelModule = Kodein.Module("view_model_module") {
    ...
    bind<ViewModel>(tag = TaskListFragmentViewModel::class.java) with provider { TaskListFragmentViewModel(instance(), instance(), instance(), instance(), instance()) }
    ...
    bind<ViewModel>(tag = DashboardFragmentViewModel::class.java) with provider { DashboardFragmentViewModel(instance()) }
}