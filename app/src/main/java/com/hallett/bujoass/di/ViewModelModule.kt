...
val viewModelModule = Kodein.Module("view_model_module") {
    ...
    bind<ViewModel>(tag = ViewTaskFragmentViewModel::class.java) with provider { ViewTaskFragmentViewModel(instance(), instance(), instance(), instance(), instance(), instance(), instance()) }
